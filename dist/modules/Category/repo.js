...
function list(query = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        const records = yield model_1.default.find(query).populate({
            path: "subCategories",
            select: "name cover",
        });
        return records;
...
function isExist(value, query = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        const record = yield model_1.default.findOne(Object.assign({ _id: value }, query)).populate({
